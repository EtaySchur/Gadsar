...
angular.module('app', ['pascalprecht.translate' , 'ui.bootstrap'])
    ...
    .config(function($translateProvider) {
        $translateProvider.translations('heb', {
            ...
            nextInterviewText: " . ראיונות ראשונים יהיו בתאריך 13.8.2015 בשעה 18:00 ובתאריך 16.8.2015 בשעה 19:00 במשרד עורך דין חגי אברהמי - שד' שאול המלך 39 , בית הדר דפנה - בניין בי קומה 7 - תל אביב *",
